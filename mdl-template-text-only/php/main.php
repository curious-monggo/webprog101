    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--primary">
        ...
        <div class="mdl-layout--large-screen-only mdl-layout__header-row">
          <h3>Whaat? &amp; An online forum for SHS</h3>
        </div>
        <div class="mdl-layout--large-screen-only mdl-layout__header-row">
        </div>
        <div class="mdl-layout__tab-bar mdl-js-ripple-effect mdl-color--primary-dark">
          <a href="#home" class="mdl-layout__tab is-active">Forum</a>
          <a href="#randompage" class="mdl-layout__tab">Random page</a>
          <a href="#randompage2" class="mdl-layout__tab">Random page 2</a>
          <a href="#html" class="mdl-layout__tab">HTML</a>
          <a href="#css" class="mdl-layout__tab">CSS</a>
          <a href="#java" class="mdl-layout__tab">JAVA</a>
      ...
      <main class="mdl-layout__content">
        ...
        <div class="mdl-layout__tab-panel" id="randompage">
          <section class="section--center mdl-grid mdl-grid--no-spacing">
            <div class="mdl-cell mdl-cell--12-col">
              <h4>Random page(Use this for articles or things needing detailed explanation</h4>
       ...
       <div class="mdl-layout__tab-panel" id="html">
          <section class="section--center mdl-grid mdl-grid--no-spacing">
            <div class="mdl-cell mdl-cell--12-col">
                ...
                <div class="mdl-cell mdl-cell--8-col">
                  <div class="demo-card-wide mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                      <h2 class="mdl-card__title-text">Intro page here</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
              ...
              <div class="mdl-grid">
                ...
                <div class="mdl-cell mdl-cell--4-col">
                  ...
                  <div class="demo-card-square mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">
                      <h2 class="mdl-card__title-text">HTML Topic #1</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Aenan convallis.
                 ...
                 <div class="mdl-cell mdl-cell--4-col">
                  ...
                  <div class="demo-card-square mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">
                      <h2 class="mdl-card__title-text">HTML Topic #2</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Aenan convallis.
                 ...
                 <div class="mdl-cell mdl-cell--4-col">
                  <div class="demo-card-square mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">
                      <h2 class="mdl-card__title-text">HTML Topic #3</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Aenan convallis.
                ...
                <div class="mdl-cell mdl-cell--12-col mdl-card mdl-shadow--4dp">
                    <div class="mdl-card__title">
                        <h2 class="mdl-card__title-text">Dummy text</h2>
                    </div>
                    <div class="mdl-card__media">
                        <img class="article-image" src=" images/mini2.png" border="0" alt="">
                    </div>
       ...
       <div class="mdl-layout__tab-panel" id="randompage2">
          <section class="section--center mdl-grid mdl-grid--no-spacing">
            <div class="mdl-cell mdl-cell--12-col">
                 <div class="mdl-cell mdl-cell--12-col mdl-card mdl-shadow--4dp">
                    <div class="mdl-card__title">
       ...
       <div class="mdl-layout__tab-panel" id="css">
          <section class="section--center mdl-grid mdl-grid--no-spacing">
            <div class="mdl-cell mdl-cell--12-col">
              ...
              <div class="mdl-grid">
                ...
                <div class="mdl-cell mdl-cell--8-col">
                  <div class="demo-card-wide mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                      <h2 class="mdl-card__title-text">CSS Intro page here</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Mauris sagittis pellentesque lacus eleifend lacinia...
              ...
              <div class="mdl-grid">
                ...
                <div class="mdl-cell mdl-cell--4-col">
                  ...
                  <div class="demo-card-square mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">
                      <h2 class="mdl-card__title-text">CSS Topic #1</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Aenan convallis.
                 ...
                 <div class="mdl-cell mdl-cell--4-col">
                  ...
                  <div class="demo-card-square mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">
                      <h2 class="mdl-card__title-text">CSS Topic #2</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Aenan convallis.
                 ...
                 <div class="mdl-cell mdl-cell--4-col">
                  <div class="demo-card-square mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">
                      <h2 class="mdl-card__title-text">CSS Topic #3</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Aenan convallis.
       ...
       <div class="mdl-layout__tab-panel" id="java">
          <section class="section--center mdl-grid mdl-grid--no-spacing">
            <div class="mdl-cell mdl-cell--12-col">
              ...
              <div class="mdl-grid">
                ...
                <div class="mdl-cell mdl-cell--8-col">
                  <div class="demo-card-wide mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                      <h2 class="mdl-card__title-text">Java Intro page here</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Mauris sagittis pellentesque lacus eleifend lacinia...
              ...
              <div class="mdl-grid">
                ...
                <div class="mdl-cell mdl-cell--4-col">
                  ...
                  <div class="demo-card-square mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">
                      <h2 class="mdl-card__title-text">Java Topic #1</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Aenan convallis.
                 ...
                 <div class="mdl-cell mdl-cell--4-col">
                  ...
                  <div class="demo-card-square mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">
                      <h2 class="mdl-card__title-text">Java Topic #2</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Aenan convallis.
                 ...
                 <div class="mdl-cell mdl-cell--4-col">
                  <div class="demo-card-square mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">
                      <h2 class="mdl-card__title-text">Java Topic #3</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Aenan convallis.
       ...
       <div class="mdl-layout__tab-panel" id="sql">
          <section class="section--center mdl-grid mdl-grid--no-spacing">
            <div class="mdl-cell mdl-cell--12-col">
              ...
              <div class="mdl-grid">
                ...
                <div class="mdl-cell mdl-cell--8-col">
                  <div class="demo-card-wide mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                      <h2 class="mdl-card__title-text">SQL Intro page here</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Mauris sagittis pellentesque lacus eleifend lacinia...
              ...
              <div class="mdl-grid">
                ...
                <div class="mdl-cell mdl-cell--4-col">
                  ...
                  <div class="demo-card-square mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">
                      <h2 class="mdl-card__title-text">SQL Topic #1</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Aenan convallis.
                 ...
                 <div class="mdl-cell mdl-cell--4-col">
                  ...
                  <div class="demo-card-square mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">
                      <h2 class="mdl-card__title-text">SQL Topic #2</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Aenan convallis.
                 ...
                 <div class="mdl-cell mdl-cell--4-col">
                  <div class="demo-card-square mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title mdl-card--expand">
                      <h2 class="mdl-card__title-text">SQL Topic #3</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Aenan convallis.
